...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.product_details2, menu);
        return true;
    }
...
//        } else if (id == R.id.nav_orders) {
            ...
            Intent intent = new Intent(ProductDetails2Activity.this, SettingsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            Paper.book().destroy();

            Intent intent = new Intent(ProductDetails2Activity.this, LoginActivity.class);
